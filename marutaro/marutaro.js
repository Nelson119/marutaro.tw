...
if ($(window).width() > 768) {
  ...
  option.template = '<div class="sample-box col-md-4 col-sm-12"><img src="http:{{image}}" alt=" {{caption}} " /></div>';
  ...
  option.template = '<div class="item"> <div class="fill"><img src="http:{{image}}"/></div> </div>';
